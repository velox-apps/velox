...
/// Registry for managing active channels within a command context
...
/// JavaScript code for the frontend Channel API
...
/// Download event for file downloads
...
/// Stream event for generic streaming operations
