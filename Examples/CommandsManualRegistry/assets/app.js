// Velox CommandsManualRegistry - Frontend JavaScript
...
async function person() {
  ...
  const result = await invoke('person', { person: { name, age, email } });
...
console.log('CommandsManualRegistry example loaded - using CommandRegistry DSL');
